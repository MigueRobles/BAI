...
\title{	
\normalfont \normalsize 
\textsc{\textbf{Bio-Inspired Artificial Intelligence} \\ Universität Hamburg} \\ [25pt] % Your university, school and/or department name(s)
~\\
~\\
~\\
\horrule{0.5pt} \\[0.4cm] % Thin top horizontal rule
\Huge Sentimental ChatBox\\ % The assignment title
...
\footnotesize{Duyu Tang, Furu Wei, Bing Qin, Ting Liu, Ming Zhou\\
Coooolll: A Deep Learning System for Twitter Sentiment Classification}

\footnotesize{ElEconomista
¿Qué son exactamente los chatbots y para qué sirven?}
