...
\newcommand{\trtype}{Seminar} %{Seminararbeit} %{Proseminararbeit}
\newcommand{\trcourse}{Bio - Inspired Artificial Intelligence}
\newcommand{\trtitle}{Chatbots: Review, sentiment analisys and
a comparison human-chatbot}
...
\newcommand{\trwebsiteordate}{28-02-2018}
  ...
  \begin{centering}
    ...
    \end{beamercolorbox}
	  ...
	  \begin{beamercolorbox}[ht=8ex,center]{}
		  \includegraphics[width=0.20\paperwidth]{../src/wtmIcon.pdf}
	  \end{beamercolorbox}%
...
\frame[t]{
  \frametitle{Birth of Chatbots}
  \begin{itemize}
  	\item The need to create virtual machines that speak as if they were human beings born in the decade of the 60's
  	
  
  	\item Chatbots: Asking question and giving answers
  	
  	\item E.L.I.Z.A.
		\begin{itemize}
			\item Created in 1966 by Joseph Weizenbaum
			
			\item Artificial psychotherapist 
		\end{itemize}
	\item
...
\frame[t]{
 ...
 % \begin{figure}[t]
	\includegraphics[width=8cm]{./Pictures/eliza.png}
	\centering
	%\end{figure}

  \begin{itemize}
  	\item Emulates a Rogerian psychotherapist.

		\item E.L.I.Z.A. has almost no intelligence whatsoever
		
		
		\item Only tricks like string substitution and canned responses based on keywords. 
		\item Yet when the original ELIZA first appeared in the 60's, some people actually mistook her for human. 
...
\frame[t]{
  \frametitle{E.L.I.Z.A.}
  \begin{itemize}
  	\item Emulates a Rogerian psychotherapist.
		
	\item "Chatbots are computer programs that interact with users using natural languages"[SA07]
	
	\item A chatbot is a conversational bot whose objetive is to interract with the user, asking question, giving answers or even initiating new topics of conversation.
...
\frame[t]{
  \frametitle{Question}
  \begin{itemize}
  	\item But the real question is: Are chatbots able to have feelings?
			\item W1e have studied deeply the sentimental analisys
...
\frame[t]{
  \frametitle{Review on the Basics}
  \begin{itemize}
  	\item Original chatbot E.L.I.Z.A.
  	 \begin{itemize}
	  	\item How it works?
		\item Our implementation
		\item Is it have been important in the histoy?
  	 \end{itemize}
	\item A.L.I.C.E.
...
\frame[t]{
  ...
  \begin{itemize}
  	\item "Chatbots are computer programs that interact with users using natural languages." \textsuperscript{[Shawar,2017]}
  	 \item Sentiment analysis refers to the use of natural language processing, text analysis, computational linguistics, and biometrics to systematically identify, extract, quantify, and study affective states and subjective information. 
