...
Pattern gives us the necessary tools to execute the sentimental analisys of the messages that the chatbot receives. NLTK(Natural Language Toolkit) is going to help us to work with human language data. 
